...
*/
#include "Beacon.h"
#include "applespoof.h"
#include "deauth.h"
#include "ELECHOUSE_CC1101_SRC_DRV.h"
#include "animations.h"
#include "mainmenu.h"
#include "dolphinreactions.h"
#include "HIZMOSwebserver.h"
#include <stdint.h>
#include <Arduino.h>
#include <U8g2lib.h>
#include <SPI.h>
...
void lazyInitCC1101(uint8_t which) {
  ...
  static const unsigned char image_sub1_10pxsub1_10px_bits[] U8X8_PROGMEM = {
    0x0c,0x00,0x03,
    0x0c,0x00,0x03,
    0xc3,0x30,0x0c,
    0xc3,0x30,0x0c,
  ...
  if (which == 1 || which == 2) {
    ...
    attachInterrupt(
      digitalPinToInterrupt(selected.gdo0),
      pulseISR,
      CHANGE
    );
  ...
  u8g2.drawXBMP(
    ...
    20,
    20,
    image_sub1_10pxsub1_10px_bits
  );

  // STATUS
  u8g2.setFont(u8g2_font_haxrcorp4089_tr);

  if (*(modules[0].initedFlag)) {

    u8g2.drawStr(14, 57, "READY");

  } else {

    u8g2.drawStr(8, 57, "NOTFOUND");
  }
  ...
  if (*(modules[1].initedFlag)) {

    u8g2.drawStr(81, 57, "READY");

  } else {

    u8g2.drawStr(75, 57, "NOTFOUND");
  }
